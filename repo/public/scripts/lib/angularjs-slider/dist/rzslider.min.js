    ...
    var b = a.module("rzModule", []).factory("RzSliderOptions", function () {
        ...
        return h.prototype = {
            init: function () {
                ...
                var a;
                a = this.scope.rzSliderOptions ? this.scope.rzSliderOptions() : {}, this.options = f.getOptions(a), this.options.step <= 0 && (this.options.step = 1), this.range = void 0 !== this.scope.rzSliderModel && void 0 !== this.scope.rzSliderHigh, this.options.draggableRange = this.range && this.options.draggableRange, this.options.draggableRangeOnly = this.range && this.options.draggableRangeOnly, this.options.draggableRangeOnly && (this.options.draggableRange = !0), this.options.showTicks = this.options.showTicks || this.options.showTicksValues, this.scope.showTicks = this.options.showTicks, this.options.showSelectionBar = this.options.showSelectionBar || this.options.showSelectionBarEnd || null !== this.options.showSelectionBarFromValue, this.options.stepsArray ? (this.options.floor = 0, this.options.ceil = this.options.stepsArray.length - 1, this.options.step = 1, this.customTrFn = function (a) {
                ...
                d = void 0 === d ? !0 : d;
                var e = String(d ? this.customTrFn(a, this.options.id, c) : a), f = !1;
                ...
                this.translateFn(this.maxValue, this.ceilLab, "ceil"), this.setPosition(this.ceilLab, this.barDimension - this.ceilLab.rzsd), this.getDimension(this.ceilLab)
                ...
                this.setPosition(this.minH, a), this.translateFn(this.scope.rzSliderModel, this.minLab, "model");
                var b = Math.min(Math.max(a - this.minLab.rzsd / 2 + this.handleHalfDim, 0), this.barDimension - this.minLab.rzsd);
                if (this.setPosition(this.minLab, b), this.options.getPointerColor) {
                    var c = this.getPointerColor("min");
                    this.scope.minPointerStyle = {backgroundColor: c}
                }
                this.shFloorCeil()
            }, updateHighHandle: function (a) {
                this.setPosition(this.maxH, a), this.translateFn(this.scope.rzSliderHigh, this.maxLab, "high");
                var b = Math.min(a - this.maxLab.rzsd / 2 + this.handleHalfDim, this.barDimension - this.maxLab.rzsd);
                if (this.setPosition(this.maxLab, b), this.options.getPointerColor) {
                    var c = this.getPointerColor("max");
                    this.scope.maxPointerStyle = {backgroundColor: c}
                }
                this.shFloorCeil()
                ...
                var a = 0, b = 0;
                if (this.range)b = Math.abs(this.maxH.rzsp - this.minH.rzsp), a = this.minH.rzsp + this.handleHalfDim; else if (null !== this.options.showSelectionBarFromValue) {
                    var c = this.options.showSelectionBarFromValue, d = this.valueToOffset(c);
                    this.scope.rzSliderModel > c ? (b = this.minH.rzsp - d, a = d + this.handleHalfDim) : (b = d - this.minH.rzsp, a = this.minH.rzsp + this.handleHalfDim)
                } else this.options.showSelectionBarEnd ? (b = Math.abs(this.maxPos - this.minH.rzsp) + this.handleHalfDim, a = this.minH.rzsp + this.handleHalfDim) : (b = Math.abs(this.maxH.rzsp - this.minH.rzsp) + this.handleHalfDim, a = 0);
                if (this.setDimension(this.selBar, b), this.setPosition(this.selBar, a), this.options.getSelectionBarColor) {
                    var e = this.getSelectionBarColor();
                    this.scope.barStyle = {backgroundColor: e}
                }
                ...
                if (this.minLab.rzsp + this.minLab.rzsd + 10 >= this.maxLab.rzsp) {
                    var a = this.getDisplayValue(this.scope.rzSliderModel, "model"), b = this.getDisplayValue(this.scope.rzSliderHigh, "high"), c = a === b ? a : a + " - " + b;
                    this.translateFn(c, this.cmbLab, "cmb", !1);
                    var d = Math.min(Math.max(this.selBar.rzsp + this.selBar.rzsd / 2 - this.cmbLab.rzsd / 2, 0), this.barDimension - this.cmbLab.rzsd);
                    this.setPosition(this.cmbLab, d), this.hideEl(this.minLab), this.hideEl(this.maxLab), this.showEl(this.cmbLab)
